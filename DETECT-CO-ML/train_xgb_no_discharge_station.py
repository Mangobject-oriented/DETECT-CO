...
# Same no-discharge features as the previous experiment.
FEATURES = [
    "rainfall_local_mm",
...
MODEL_OUTPUT = "xgboost_no_discharge_station_24h.joblib"
...
# ============================================================
# CONVERT STATION ID TO NUMERIC CATEGORY
# ============================================================

print()
print("Encoding station IDs...")

# Convert station IDs into categorical integer values.
df[STATION_COLUMN] = df[STATION_COLUMN].astype("category")

station_categories = df[STATION_COLUMN].cat.categories

df[STATION_COLUMN] = df[STATION_COLUMN].cat.codes

print("Number of stations:", len(station_categories))
...
X_FEATURES = [STATION_COLUMN] + FEATURES
...
print()
print("Training XGBoost without discharge + station information...")
...
print()
print("==============================")
print("XGBOOST NO-DISCHARGE + STATION")
print("==============================")
