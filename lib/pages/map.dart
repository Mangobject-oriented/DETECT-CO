...
class _MapTabState extends State<MapTab> {
  ...
  void _goToNearestEvac() {
    ...
    for (final site in evacSites) {
      final dist = distance.as(LengthUnit.Meter, currentPosition!, site.location);
      if (dist < minDist) {
        minDist = dist;
        nearest = site;
      }
  ...
  // Now takes the current dark-mode flag so the label color adapts too.
              ...
              Expanded(
                child: Stack(
                  children: [
                    ...
                    // ===== LEGEND — now adapts to dark mode =====
                    Positioned(
                      top: 16,
                      left: 16,
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isDarkMode
                              ? const Color(0xFF2C2C2C).withOpacity(0.92)
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            _legendItem(Colors.green, "Safe", isDarkMode),
                            const SizedBox(height: 6),
                            _legendItem(Colors.orange, "Medium Risk", isDarkMode),
                            const SizedBox(height: 6),
                            _legendItem(Colors.red, "Flooding", isDarkMode),
                          ],
                        ),
                      ),
                    ),
